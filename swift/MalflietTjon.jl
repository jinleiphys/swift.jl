...
# Load UIX module once at module initialization
include("../3Npot/UIX_optimized.jl")

export malfiet_tjon_solve_optimized, compute_lambda_eigenvalue_optimized, print_convergence_summary, arnoldi_eigenvalue, compute_channel_probabilities, RHSCache, precompute_RHS_cache, compute_uix_potential_optimized
