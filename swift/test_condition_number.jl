...
println("\n  The M^{-1} preconditioner achieves excellent conditioning,")
println("  reducing the condition number by more than 1000×.")
println("\n  This dramatic improvement validates the eigendecomposition-based")
println("  M^{-1} implementation for practical use in MalflietTjon.jl and")
println("  other iterative solvers for the Faddeev equation.")
println("\n  Next step: Integrate M^{-1} into GMRES solver in MalflietTjon.jl")
println("  to accelerate convergence of the iterative solution.")
println("\n" * "="^70)
